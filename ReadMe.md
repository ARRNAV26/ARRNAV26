<table width="100%">
  <tr>
    <td width="40%" valign="top">
      <img src="/arnav_saha_photo1.png" width="200" height="250" />
      <img src="/giphy.gif" width="200" height="250" />
      <h2>📊 GitHub Stats</h2>
      ...
      <br/><br/>
      <img src="https://nirzak-streak-stats.vercel.app/?user=ARRNAV26&theme=algolia&hide_border=false" width="100%" />
      <br/><br/>
      <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=ARRNAV26&theme=algolia&hide_border=false&include_all_commits=true&count_private=true&layout=compact" width="100%" />
      <h3>🏆 GitHub Trophies</h3>
      <img src="https://github-profile-trophy.vercel.app/?username=ARRNAV26&theme=great-gatsby&no-frame=false&no-bg=false&margin-w=4" width="100%" />
    ...
    <td width="60%" valign="top">
      <h2>💫 About M3</h2>
      <p>
        I’m a full-stack engineer building software where performance, reliability, and user experience are first-class concerns.
        I work primarily with <strong>Python, TypeScript, React, and Angular</strong>, delivering real-time data pipelines,
        resilient backend services, and fast, intuitive user interfaces.
      </p>
      <p>
        I prioritize pragmatic system design, observability, and quantifiable gains in throughput,
      ...
      <ul>
        <li><strong>Customer Obsession</strong> — reduce real friction</li>
        <li><strong>Performance &gt; Features</strong></li>
        <li><strong>Clean Architecture</strong></li>
        <li><strong>Data Correctness</strong></li>
      </ul>
      <h2>💻 Tech Stack</h2>
      <p>
